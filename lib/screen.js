...
(function() {
  var Screen = (function() {
    ...
    Screen.prototype.displayDelay = function displayDelay() {
      console.log('displayDelay() - this = ' + this.constructor.name);
      console.log('Turn on Delay display');
    ...
    Screen.prototype.startTimers = function startTimers() {
      ...
      screen.goalTimer = setInterval(screen.checkGoals, (screen.delay * screen.interval));
    };
    ...
    Screen.prototype.checkGoals = function checkGoals() {
      ...
      s = this.gl.goalsComplete(screen.histData);
