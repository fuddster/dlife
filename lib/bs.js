...
(function() {
  var BloodSugar = (function() {
    ...
    BloodSugar.prototype.turnOnExercise =
    function turnOnExercise(exercise, exerciseDurationOfImpact) {
      this.hasExercise = true;
      this.exercise = exercise;
      this.exerciseDurationOfImpact = exerciseDurationOfImpact;
    };

    BloodSugar.prototype.turnOnExerciseIntensity = function
    turnOnExerciseIntensity(exercise, exerciseDurationOfImpact,
                            exerciseIntensity) {
      this.hasExercise = true;
    ...
    BloodSugar.prototype.addCarbs = function addCarbs(carbs, when, msg, delay) {
      ...
      bs.carbDurationMins = 2 * bs.carbs;
