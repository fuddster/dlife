...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
  ...
  console.log(window.bs_screen);
  console.log(window);
  console.log(document);
  console.log(document.bs_screen);
}
...
(function() {
  var Screen = (function() {
    ...
    Screen.prototype.tock = function tock() {
      ...
      if (bs_screen.minuteCount == bs_screen.interval) {
        ...
        bgText.enter()
          ...
          .attr('fill', function (d) {
            if ((d < bs_screen.highLevel) && (d > bs_screen.lowLevel)) {
              return '#0f0';
            }
            if ((d >= bs_screen.maxHigh) || (d <= bs_screen.maxLow)) {
              return '#ff0';
            }
            return '#f00';
          } )
    ...
    Screen.prototype.checkGoals = function checkGoals() {
      ...
      s = this.gl.goalsComplete(bs_screen.histData);
